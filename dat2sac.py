...
# and pull the latest version from the end of 2015.
...
def getcal(calcontrol): 
    ...
    try:
        ...
        try:
            ...
            print "If a channel is unused, designate it as 'UNK' to prevent conversion."
           ...
           cconstant = ["TEST","CH0",1.0,"CH1",1.0,"CH2",1.0,"CH3",1.0,1.0,1.0,0.707,1.0,1,2,"LM"]
    return(cconstant)
